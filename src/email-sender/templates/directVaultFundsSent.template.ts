...
import type { DirectVaultFundsSentEmailParams } from '../email-sender.service.types'

export const Subject = 'Vaultleap: A Payment Has Been Successfully Sent To Your Direct Vault'

export const FirstBlueBoxContent = ({ fullName, vaultName, amount, date }: DirectVaultFundsSentEmailParams) => `
            ${TEXT(`Hey ${fullName},`, '22px', 'margin-top: 0; margin-bottom: 4px')}

            ${TEXT(`Transaction Confirmation`, '18px', 'margin-top: 0; margin-bottom: 18px')}

            ${TEXT(`A payment has been successfully sent to your Direct Vault with name ${vaultName}`, '14px', 'margin-top: 0; margin-bottom: 14px;')}
...
export const Body = (params: DirectVaultFundsSentEmailParams) => `
...
export const DirectVaultFundsSentTemplate = (params: DirectVaultFundsSentEmailParams) => ({
  Subject,
